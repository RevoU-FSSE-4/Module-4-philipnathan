...
const mainHomePageStyle: string =
    "flex flex-col justify-between align-center w-80 h-80 border self-center border-solid border-gray-900 rounded bg-gray-500";

//absolute inset-0 m-auto w-80 h-80 flex items-center justify-center

const MainHomePage: React.FC<{}> = () => {
    const [subMenu, setSubMenu] = useState<string>("login");
